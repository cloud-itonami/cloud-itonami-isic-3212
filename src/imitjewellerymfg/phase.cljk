(ns imitjewellerymfg.phase
  "Phase 0->3 staged rollout for the imitation-jewellery-workshop
  ...
  consequence (a casting/plating-equipment maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human workshop supervisor's call.
  `imitjewellerymfg.governor`'s `actuate-equipment-blocked-violations`
...
(defn verdict->disposition
  "Map an Imitation Jewellery Workshop Plant Operations Governor
