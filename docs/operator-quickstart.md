# Operator Quickstart — Manufacture of imitation jewellery and related articles

Shortest path from clone to a verified local dry-run for **ISIC 3212** (`cloud-itonami-isic-3212`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3212.git
cd cloud-itonami-isic-3212
```
...
- Blueprint governor key: `imitation-jewellery-workshop-plant-operations-governor`
- Likely source path: `imitjewellerymfg.governor.cljc`
