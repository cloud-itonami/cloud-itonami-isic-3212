# Business Model: Manufacture of imitation jewellery and related articles
...
## Classification
- Repository: `cloud-itonami-isic-3212` ([github.com/cloud-itonami/cloud-itonami-isic-3212](https://github.com/cloud-itonami/cloud-itonami-isic-3212))
- ISIC Rev.5: `3212` — Manufacture of imitation jewellery and related articles
- Domain: `:imitation-jewellery/manufacturing`
- Social impact: :worker-safety :materials-safety :consumer-protection
- Actor: `:imitation-jewellery-workshop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :imitation-jewellery/manufacturing — who wants
...
One managed tenant (:imitation-jewellery/manufacturing):
...
- Do not bypass the `:imitation-jewellery-workshop-plant-operations-governor` for production decisions.
